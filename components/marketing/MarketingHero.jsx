...
export default function AppHero() {
  ...
  return (
    <div className="relative min-h-screen pt-24 overflow-hidden">
      ...
      >
        <source src="/assets/marketing/advertising-banner.mp4" type="video/mp4" />
      </video>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="text-white">
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 leading-tight">
                <span className="text-red-500">Advertising graphic design</span> services - Stand Out from the Crowd with Bold and Innovative Advertising!
              </h1>
              
              <p className="text-md md:text-shadow-md mb-3 leading-relaxed text-gray-200">
                Are you ready to make your business soar? The key to success is capturing the attention of the public. And that's where our advertising graphic design services come to the rescue. We have a proven track record of helping businesses just like yours stand out in a crowded marketplace and establish themselves as the dominant force in their industry.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start p-0 m-0 space-x-3">
                  ...
                  <p className="text-gray-200 text-sm">Stand out in the crowded marketplace with our expert advertising solutions.</p>
                </div>
                ...
                <div className="flex items-start p-0 m-0 space-x-3">
                  ...
                  <p className="text-gray-200 text-sm">Gain a competitive edge in your industry with our data-driven, results-oriented approach</p>
                </div>
