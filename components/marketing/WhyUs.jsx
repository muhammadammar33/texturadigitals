        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700 text-sm font-semibold">Postcards, flyers, and brochures</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700 text-sm font-semibold">Booklet Leaflet Pamphlet</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700 text-sm font-semibold">Direct Mail</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700 text-sm font-semibold">Poster Album Cover</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-4 h-4 bg-orange-500 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-700 text-sm font-semibold">Infographic</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-4 h-4 bg-orange-500 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-700 text-sm font-semibold">Automobile, truck, or van Wrap</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-4 h-4 bg-orange-500 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-700 text-sm font-semibold">Billboard</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-4 h-4 bg-orange-500 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-700 text-sm font-semibold">Banners</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-4 h-4 bg-orange-500 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700 text-sm font-semibold">Newsletter via email</span>
              </div>
            </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              <Image
                src="/assets/marketing/Bring-your-tale-to-life-with-organically-moving-videos-and-animations.Business-and-Advertising.jpg"
