...
export default function BookPublishingHero() {
  ...
  return (
    <div className="relative min-h-screen pt-24 overflow-hidden">
      ...
      >
        <source src="/assets/bookPublishing/book-and-magazine-video.mp4" type="video/mp4" />
      </video>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="text-white">
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 leading-tight">
                Professional Book Publishing Services for Aspiring Authors
              </h1>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start p-0 m-0 space-x-3">
                  ...
                  <p className="text-gray-200 text-sm">Custom Cover Design: Eye-catching covers tailored to your book's genre and audience.</p>
                </div>
                ...
                <div className="flex items-start p-0 m-0 space-x-3">
                  ...
                  <p className="text-gray-200 text-sm">Editing & Proofreading: Professional polishing for a flawless manuscript.</p>
                </div>
                ...
                <div className="flex items-start space-x-3 p-0 m-0">
                  ...
                  <p className="text-gray-200 text-sm">Publishing & Distribution: ISBN registration, eBook and print publishing, global reach.</p>
                </div>
              </div>
