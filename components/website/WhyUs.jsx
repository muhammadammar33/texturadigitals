        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700 mb-8 leading-relaxed">
              Our approach combines innovation, design expertise, and technical proficiency to deliver websites that meet your business objectives and exceed your expectations. We don't just build websites – we create digital experiences that drive growth, engagement, and success.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700 text-sm font-semibold">User-Centric Design</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700 text-sm font-semibold">Speed & Performance</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700 text-sm font-semibold">Ongoing Support</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700 text-sm font-semibold">SEO Optimization</span>
              </div>
            </div>
