...
export default function HeroSection() {
  return (
    <div
      className="relative bg-cover bg-center bg-no-repeat px-4 py-8 sm:px-6 lg:pl-50 lg:pt-60 pb-8 lg:pb-16 pr-16 sm:pr-20"
      style={{
    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0 items-center mt-16 sm:mt-20 lg:mt-0">
        <div className="space-y-4 lg:space-y-6 lg:pr-30 order-2 lg:order-1">
          ...
          <p className="text-sm sm:text-base text-shadow-md text-gray-300 leading-relaxed lg:pr-30">
        ...
        <div className="flex justify-center lg:ml-[-100px] lg:mr-10 order-1 lg:order-2">
          <Image 
            src="/assets/imac.webp" 
            alt="iMac showcase" 
            width={800} 
            height={600}
            className="w-full max-w-sm sm:max-w-md lg:max-w-none h-auto"
          />
        </div>
      </div>

      {/* Partner/Trust Images */}
      <div className="relative z-10 mt-6 sm:mt-8 lg:mt-4 flex gap-4 sm:gap-6 lg:gap-8 flex-wrap justify-center lg:justify-start">
        <Image 
